/*
A forma mais simples de criar interações de entrada e saída no terminal é utilizando os objetos stdin e stdout disponíveis através da variável global process. Essas são as entradas e saídas padrão, que nesse caso estão diretamente conectadas ao terminal:
...
/* 
No entanto, o Node.js fornece um módulo nativo que serve para facilitar a criação de interações de leitura/escrita, ou pergunta/resposta, o módulo readline. Com ele podemos criar uma interface que possui input e output, e então usá-las para diversas funcionalidades:
